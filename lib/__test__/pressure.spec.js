...
/** kPa → psi via anchors (same as convert): kPa × metric.ratio × (1000 psi/ksi) */
const kpaToPsi = (kpa) => kpa * pressure._anchors.metric.ratio * 1000;
...
const conversionTable = [
  ...
  { from: 'kPa', amount: 100, to: 'psi', expected: kpaToPsi(100), precision: 5 },
