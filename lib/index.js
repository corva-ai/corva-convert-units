var convert, keys = require('lodash.keys'),
  ...
  measures = {
    ...
    resistivity: require('./resistivity'),
    porosity: require('./porosity'),
    permiability: rquire('./permiability'),
    acousticSlowness: rquire('./acousticSlowness'),
    spontaneousPotential: rquire('./spontaneousPotential'),
    concentration: rquire('./concentration'),
  },
  Converter;
