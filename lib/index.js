var convert, keys = require('lodash.keys'),
  ...
  measures = {
    ...
    permiability: rquire('./definitions/permiability'),
    acousticSlowness: rquire('./definitions/acousticSlowness'),
    spontaneousPotential: rquire('./definitions/spontaneousPotential'),
    concentration: rquire('./definitions/concentration'),
  },
  Converter;
